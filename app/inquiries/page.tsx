...
const BUDGET_RANGES = [
  "Under LKR50,000",
  "LKR50,000 – LKR150,000",
  "LKR150,000 – LKR500,000",
  "LKR500,000+",
  "Not sure yet",
];
...
export default function InquiriesPage() {
  ...
  const addService = (name: string) => {
    if (!formData.service_types.includes(name)) {
      setFormData((prev) => ({
        ...prev,
        service_types: [...prev.service_types, name],
      }));
    }
  };
  ...
  const removeService = (name: string) => {
    setFormData((prev) => ({
      ...prev,
      service_types: prev.service_types.filter((s) => s !== name),
    }));
  };
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 md:p-10 shadow-sm">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                  Fill out the form below. All fields marked with * are
                  required.
                </p>
              </div>
                ...
                {[
                  {
                    step: "01",
                    title: "Review",
                    desc: "Our team reviews your inquiry within 24 hours",
                  },
                  {
                    step: "02",
                    title: "Consultation",
                    desc: "We schedule a call to understand your needs better",
                  },
                  {
                    step: "03",
                    title: "Proposal",
                    desc: "You receive a detailed technical proposal & quote",
                  },
                  {
                    step: "04",
                    title: "Kickoff",
                    desc: "Project starts with a dedicated project manager",
                  },
                ].map((item, idx) => (
            ...
            <div className="bg-primary text-primary-foreground rounded-2xl p-8">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+94701533195" className="hover:underline">
                    +94 70 153 3195
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="mailto:info@aircurrentengineeringsolution.com"
                    className="hover:underline"
                  >
                    info@aircurrentengineeringsolution.com
                  </a>
                </div>
                <div className="flex items-center gap-3">
      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open && dialogState !== "submitting") setDialogState(null);
        }}
      >
        <DialogContent
          showCloseButton={dialogState !== "submitting"}
        ...
        >
          {dialogState === "confirm" && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Are you sure you want to submit this inquiry? Our team will
          ...
          {dialogState === "success" && (
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <DialogDescription>
                Thank you! We've received your inquiry and will get back to you
                within 24 hours.
              </DialogDescription>
              <Button
