...
export default function ServiceTagsPage() {
  ...
  const handleEditTag = (tag: ServiceTag) => {
    setEditingTag(tag);
    setFormData({
      name: tag.name,
      slug: tag.slug,
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Service Tags</h1>
          <p className="mt-2 text-gray-600">Manage tags for services</p>
        </div>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Add New Service Tag</DialogTitle>
              <DialogDescription>
                Create a new tag for categorizing services.
              </DialogDescription>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Search Service Tags</CardTitle>
        </CardHeader>
        <CardContent>
